...
\paperw11900\paperh16840\margl1440\margr1440\vieww11060\viewh14100\viewkind0
...
\fs48 How the game works\

\fs24 \
The game is played offline and with 3 players. Player\'92s turn. He chooses to auction or trade. \
\
...
\
Players need to be able to see there stats at all times. Animals (and thus score) are open; everyone can see the distribution of the animals. For the money this is a bit different. The \ul amount of money cards\ulnone  is open, but the \ul total amount\ulnone  is hidden. This is shown by holding down finger on money cards digit. (Optional: input 3 digit password to avoid dirty play)\
\
\
\
\
